...
?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Product Booking</h1>
                    <p class="mb-4"></p>
...
</a> | <a href="productbookings.php" style="text-decoration:none" >Product Booking Details</a></h6>
<!-- BreadCrubs End -->
                        </div>
                        <div class="card-body">
...
if($s==0)
 ...
 <a href='../fpdf/productbillnotpaid.php?t=<?php echo $row['pbkey']; ?>' target='_blank'>
...
echo "<b><font color='green'>Paid</font></b>"; ?>&nbsp;
        <a href='../fpdf/productbillpaid.php?t=<?php echo $row['pbkey']; ?>' target='_blank'><button type="button" class="btn btn-outline-success"><i class="fas fa-download"></i></button></a>    
