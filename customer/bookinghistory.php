...
?>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Service Booking</h1>
                    <p class="mb-4"></p>
...
</a> | <a href="bookinghistory.php" style="text-decoration:none" >Service Booking Details</a></h6>
<!-- BreadCrubs End -->
                        </div>
                        <div class="card-body">
...
{
    echo "<b><font color='green'>Paid</font></b>"; ?>&nbsp; <a href="../fpdf/servicebillpaid.php?t=<?php echo $row['bk_key']; ?>" target='_blank'>
