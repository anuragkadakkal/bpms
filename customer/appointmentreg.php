...
session_start();
 include('../connection.php');
	...
	$sql3="insert into tb_booking(bk_key,bk_fullname,bk_email,bk_address,bk_apdate,bk_timeslot,bk_phone,bk_catid,bk_subcatid,bk_amt,bk_status,bk_userid,curdatebook) values ('".$k2."','".$fname."','".$email."','".$address."','".$apdate."','".$slot."','".$phone."','".$catid."','".$subcatid."','".$bkamt."','".$status."','".$userid."','".$curdate."')";//echo $sql3;exit;
