	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			$curdate = date("l jS \of F Y"); //echo $curdate;exit;
				$product_array = $db_handle->runQuery("SELECT * FROM tb_subcat where catid='".$_SESSION['catid']."' and scatstatus!='0' and delstatus!='1'");
			...
			<td style="text-align: left"> <img height="300px" width="300px" src="../admin/Uploads/<?php echo $product_array[$key]["scatkey"]."/".$product_array[$key]["image"]; ?>"></td>
