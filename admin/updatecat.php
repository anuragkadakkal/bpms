...
</a> | <a href="viewcategory.php" style="text-decoration:none" >Product Category Details</a> | <a href="updatecat.php?t=<?php echo $_GET['t']; ?>" style="text-decoration:none" >Update Product Category</a></h6>
<!-- BreadCrubs End -->
                        </div>
                        <div class="card-body" >
