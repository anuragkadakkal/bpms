            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities5" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="viewreports.php">Reports</a>
                        <a class="collapse-item" href="../fpdf/staffreport.php" target="_blank">Staff Details</a>
                        <a class="collapse-item" href="../fpdf/userreport.php" target="_blank">User Details</a>
                        <a class="collapse-item" href="../fpdf/productreport.php" target="_blank">Products Details</a>
                        <a class="collapse-item" href="../fpdf/servicereport.php" target="_blank">Service Details</a>
                    </div>
                </div>
            </li>
