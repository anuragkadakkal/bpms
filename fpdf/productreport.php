...
$sql="select catname,scatname,amt,scatstatus,tb_subcat.delstatus from tb_subcat inner join tb_category on tb_subcat.catid=tb_category.catid";//echo $sql;exit;
...
$pdf->Output('I','productDetails.pdf');
