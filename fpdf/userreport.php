...
$sql="select * from tb_customer inner join tb_login on tb_login.id=tb_customer.loginid";//echo $sql;exit;
...
$pdf->Write (5, "Customer Personal Details");
